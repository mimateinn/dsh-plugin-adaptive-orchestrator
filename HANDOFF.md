...
**GUI boundary (user directive):** Do NOT touch GUI/Web rebuild — Settings UI, GUI E2E, 127.0.0.1:43120 verification, and visual acceptance are forbidden and remain pending; headless/integration acceptance is the current substitute.
